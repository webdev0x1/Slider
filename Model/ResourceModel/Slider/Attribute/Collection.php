<?php
namespace Wisepet\Slider\Model\ResourceModel\Slider\Attribute;
...
class Collection extends \Magento\Eav\Model\ResourceModel\Entity\Attribute\Collection
{
     ...
     *
     * @return \Wisepet\Slider\Model\ResourceModel\Slider\Attribute\Collection
     */
    ...
    {
        $this->_init(
            \Wisepet\Slider\Model\Slider\Attribute::class,
    ...
    protected function _initSelect()
    {
        $entityTypeId = $this->eavConfig->getEntityType(
            \Wisepet\Slider\Model\Slider\Attribute::ENTITY_TYPE_CODE
        )->getEntityTypeId();
        ...
        $this->getSelect()->from(
            ...
            ['additional_table' => $this->getTable('wisepet_slider_eav_attribute')],
